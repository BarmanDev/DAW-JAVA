...
public class T4_Act_02 {
    /*
    * Escribe un programa de nombre PidiendoValores que llame a una función encargada de pedir un número entero superior a 0.
    * Si el usuario escribe un número incorrecto, vuelve a pedir. Cuando el usuario haya escrito
    * un número correcto la función ha de retornar ése número y desde la función main se ha de mostrar el número introducido.*/
